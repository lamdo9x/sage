...
```bash
node claude-code/apply-theme.js
```

Copies `sage-theme.json` to `~/.claude/themes/` and sets it as the active theme. Only installs if not already present. Requires Claude Code v2.1.118+.
